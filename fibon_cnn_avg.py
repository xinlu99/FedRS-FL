...
# 生成输出文件名
output_filename = f'result_fibon/all_avg_fibon_cnn_FL{NUM_ROUNDS}_task_epoch{EPOCHS}_bs{BATCH_SIZE}_learnrate{LEARNING_RATE}_client{NUM_CLIENTS}.txt'
detailed_results_filename = f'result_fibon/avg_detailed_results_task_final_round.txt'

# 1. 读取CSV文件
input_filename = f'1csv_fibon/fibon_avg_tasks_all.csv'
...
features = ['Concurrent task count', 'Total Fibonacci size', 'New task start time (relative)',
            ...
            'Avg task start time', 'Avg task operations (GFLOPs)']
