...
# 准备输出的CSV文件
#output_file = 'compute/loss—rounds_all_com.csv'
output_file = 'pic/loss—rounds_all_com.csv'
# 打开输出文件准备写入
with open(output_file, 'w', newline='') as csvfile:
    ...
    for num in range(1, 11):
        # 准备每个文件的输入文件名compute/fibon_cnn_FL100_task10_epoch20_bs64_learnrate0.001_client10.txt
        ...
        with open(input_file, 'r') as file:
            ...
            for line in lines[1:]:
                ...
                if round_num in target_rounds:
                    selected_data.extend([data[1], data[4], data[7]])  # 依次追加 'MAE of global', 'Max MAE of client', 'Avg MAE of client'
